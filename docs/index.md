...
## Quick Start Notes:
1. Install the LogicMonitor.DataSDK NuGet package into your project.
```csharp
Install-Package Logicmonitor.DataSDK -Version 0.0.4-alpha
```
OR
```csharp
dotnet add package Logicmonitor.DataSDK --version 0.0.4-alpha
```
